    ...
    addCommands(
      // new ParallelRaceGroup(
        new SequentialCommandGroup(
          new CMD_SetInitalOdometry(p_drivetrain, p_trajectories.CubeRunTrajectoryBlue1),
        ...
        new CMD_SetInitalOdometry(p_drivetrain, p_trajectories.CubeRunTrajectoryBlue2),
        new ParallelDeadlineGroup(
          new SequentialCommandGroup(
            new WaitCommand(.5),
            p_trajectories.driveTrajectory(p_trajectories.CubeRunTrajectoryBlue2)
          ),
          new SequentialCommandGroup(
        ...
        new CMD_SetInitalOdometry(p_drivetrain, p_trajectories.CubePlaceTrajectoryBlue2),
