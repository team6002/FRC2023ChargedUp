...
public class CMD_PlaceForwardsCubeAuto extends SequentialCommandGroup {

  public CMD_PlaceForwardsCubeAuto(SUB_Elevator p_elevator, SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Wrist p_wrist, 
  SUB_FiniteStateMachine p_finiteStateMachine, GlobalVariables p_variables
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new CMD_ElevatorSetPosition(p_elevator, ElevatorConstants.kElevatorThirdCubeLevel - 15),
