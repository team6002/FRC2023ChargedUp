...
public class CMD_HoldShelfForwards extends SequentialCommandGroup {
  public CMD_HoldShelfForwards(SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Elevator p_elevator, SUB_Wrist p_wrist,
